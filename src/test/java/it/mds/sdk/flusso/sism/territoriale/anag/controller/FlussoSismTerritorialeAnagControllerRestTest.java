...
class FlussoSismTerritorialeAnagControllerRestTest {

    @InjectMocks
    @Spy
    private FlussoSismTerritorialeAnagControllerRest controller;
    ...
    @Mock
    private FlussoSismTerrServiceAnag service;
    private ConfigurazioneFlussoSismTerritorialeAnag.Rules rules = mock(ConfigurazioneFlussoSismTerritorialeAnag.Rules.class);

    private ConfigurazioneFlussoSismTerritorialeAnag.Flusso flusso = mock(ConfigurazioneFlussoSismTerritorialeAnag.Flusso.class);
    ...
    private ConfigurazioneFlussoSismTerritorialeAnag.NomeFlusso nomeFlusso = Mockito.mock(ConfigurazioneFlussoSismTerritorialeAnag.NomeFlusso.class);
