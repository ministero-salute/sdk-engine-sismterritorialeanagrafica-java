...
@Slf4j
@Component("flussoSismTerrServiceAnag")
public class FlussoSismTerrServiceAnag {


    private ParserRegole parserRegole;
    private ParserTracciato parserTracciato;
    private ValidationEngine validationEngine;
    private TracciatoSplitter<RecordDtoSismTerritorialeAnag> tracciatoSplitter;
    ...
    private static final String XML_FLUSSO_TAG = "</TerritorialeAnagrafica><TerritorialeAnagrafica>";
    private final String NOME_FILE_XSD_SISM = "ANT.xsd";
    ...
    @Autowired
    public FlussoSismTerrServiceAnag(@Qualifier("parserRegoleSismTerrAnag") final ParserRegole parserRegole,
                                     ...
                                     @Qualifier("tracciatoSplitterSismTerrAnag") final TracciatoSplitter<RecordDtoSismTerritorialeAnag> tracciatoSplitter,
    ...
    public void validazioneBlocchi(int dimensioneBlocco, String nomeFile, RegoleFlusso regoleFlusso, String idRun,
        ...
        TerritorialeAnagrafica territorialeAnagrafica = null;
        File file = getfileFromPath(conf.getFlusso().getPercorso() + nomeFile);
        String nomeFileXml = conf.getXmlOutput().getPercorso() + "SDK_TER_ANT_" + periodoRiferimento + "_" + idRun + ".xml";
        ...
        do {
            ...
            List<RecordDtoSismTerritorialeAnag> recordConv =
                    bloccoValidazione.getRecordList().stream().map(k -> (RecordDtoSismTerritorialeAnag) k).collect(Collectors.toList());
            ...
            if (!recordConv.isEmpty()) {
                ...
                territorialeAnagrafica = ((TracciatoSplitterImpl) tracciatoSplitter).creaTerritorialeAnagrafica(recordConv, territorialeAnagrafica);
            } else {
            ...
            if (isWriteOk) {
                ...
                try {
                    gestoreFile.scriviDtoFragment(territorialeAnagrafica, nomeFileXmlTmp, urlXsd);
